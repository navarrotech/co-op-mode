...
const Handlers: Handler = {
  ...
  Media: async function mediaHandler(type, data, buffer) {
    ...
    publish('Media', sockets, type, buffer)
  },
  ...
  Messages: async function messagesHandler(type, data, buffer) {
    ...
    const ownerIsFirst = conversation.user1_id === data.owner_id
    const ownerIsSecond = conversation.user2_id === data.owner_id
