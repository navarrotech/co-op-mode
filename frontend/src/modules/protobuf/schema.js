...
export const FormInvalid = $root.FormInvalid = (() => {
    ...
    FormInvalid.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.FormInvalid();
    ...
    FormInvalid.fromObject = function fromObject(object) {
        if (object instanceof $root.FormInvalid)
            return object;
        let message = new $root.FormInvalid();
...
export const FormsInvalid = $root.FormsInvalid = (() => {
    ...
    FormsInvalid.encode = function encode(message, writer) {
        ...
        if (message.invalid != null && message.invalid.length)
            for (let i = 0; i < message.invalid.length; ++i)
    ...
    FormsInvalid.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.FormsInvalid();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    FormsInvalid.verify = function verify(message) {
        ...
        if (message.invalid != null && message.hasOwnProperty("invalid")) {
            ...
            for (let i = 0; i < message.invalid.length; ++i) {
                let error = $root.FormInvalid.verify(message.invalid[i]);
                if (error)
    ...
    FormsInvalid.toObject = function toObject(message, options) {
        ...
        if (message.invalid && message.invalid.length) {
            object.invalid = [];
            for (let j = 0; j < message.invalid.length; ++j)
...
export const User = $root.User = (() => {
    ...
    User.encode = function encode(message, writer) {
        ...
        if (message.dislikes != null && message.dislikes.length)
            for (let i = 0; i < message.dislikes.length; ++i)
    ...
    User.verify = function verify(message) {
        ...
        if (message.media != null && message.hasOwnProperty("media")) {
            ...
            for (let i = 0; i < message.media.length; ++i) {
                let error = $root.Media.verify(message.media[i]);
                if (error)
                    return "media." + error;
            }
        }
        if (message.likes != null && message.hasOwnProperty("likes")) {
            ...
            for (let i = 0; i < message.likes.length; ++i) {
                let error = $root.Likes.verify(message.likes[i]);
                if (error)
                    return "likes." + error;
            }
        }
        if (message.dislikes != null && message.hasOwnProperty("dislikes")) {
            ...
            for (let i = 0; i < message.dislikes.length; ++i) {
                let error = $root.Dislikes.verify(message.dislikes[i]);
                if (error)
    ...
    User.fromObject = function fromObject(object) {
        ...
        if (object.dislikes) {
            ...
            message.dislikes = [];
            for (let i = 0; i < object.dislikes.length; ++i) {
    ...
    User.toObject = function toObject(message, options) {
        ...
        if (message.dislikes && message.dislikes.length) {
            object.dislikes = [];
            for (let j = 0; j < message.dislikes.length; ++j)
...
export const UserPublicInfo = $root.UserPublicInfo = (() => {
    ...
    UserPublicInfo.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.UserPublicInfo();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 2: {
    ...
    UserPublicInfo.fromObject = function fromObject(object) {
        if (object instanceof $root.UserPublicInfo)
            return object;
        let message = new $root.UserPublicInfo();
        if (object.first_name != null)
            message.first_name = String(object.first_name);
        return message;
    };
...
export const Preferences = $root.Preferences = (() => {
    ...
    Preferences.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Preferences();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    Preferences.fromObject = function fromObject(object) {
        if (object instanceof $root.Preferences)
            return object;
        let message = new $root.Preferences();
        if (object.id != null)
            message.id = String(object.id);
...
export const DatingProfile = $root.DatingProfile = (() => {
    ...
    DatingProfile.encode = function encode(message, writer) {
        ...
        if (message.fav_vplatforms != null && message.fav_vplatforms.length)
            for (let i = 0; i < message.fav_vplatforms.length; ++i)
        ...
        if (message.fav_bgames != null && message.fav_bgames.length)
            for (let i = 0; i < message.fav_bgames.length; ++i)
        ...
        if (message.known_langs != null && message.known_langs.length)
            for (let i = 0; i < message.known_langs.length; ++i)
        ...
        if (message.wanting != null && message.wanting.length)
            for (let i = 0; i < message.wanting.length; ++i)
    ...
    DatingProfile.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DatingProfile();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    DatingProfile.verify = function verify(message) {
        ...
        if (message.user != null && message.hasOwnProperty("user")) {
            let error = $root.UserPublicInfo.verify(message.user);
            if (error)
                return "user." + error;
        }
        return null;
    ...
    DatingProfile.fromObject = function fromObject(object) {
        if (object instanceof $root.DatingProfile)
            return object;
        let message = new $root.DatingProfile();
        if (object.id != null)
            message.id = String(object.id);
        if (object.owner_id != null)
            message.owner_id = String(object.owner_id);
        ...
        if (object.fav_vgames) {
            ...
            message.fav_vgames = [];
            for (let i = 0; i < object.fav_vgames.length; ++i)
        ...
        if (object.fav_vgenres) {
            ...
            message.fav_vgenres = [];
            for (let i = 0; i < object.fav_vgenres.length; ++i)
        ...
        if (object.fav_vplatforms) {
            ...
            message.fav_vplatforms = [];
            for (let i = 0; i < object.fav_vplatforms.length; ++i)
        ...
        if (object.fav_bgames) {
            ...
            message.fav_bgames = [];
            for (let i = 0; i < object.fav_bgames.length; ++i)
        ...
        if (object.known_langs) {
            ...
            message.known_langs = [];
            for (let i = 0; i < object.known_langs.length; ++i)
        ...
        if (object.wanting) {
            ...
            message.wanting = [];
            for (let i = 0; i < object.wanting.length; ++i)
        ...
        if (object.interests) {
            ...
            message.interests = [];
            for (let i = 0; i < object.interests.length; ++i)
    ...
    DatingProfile.toObject = function toObject(message, options) {
        ...
        if (message.fav_vgames && message.fav_vgames.length) {
            object.fav_vgames = [];
            for (let j = 0; j < message.fav_vgames.length; ++j)
                object.fav_vgames[j] = message.fav_vgames[j];
        }
        if (message.fav_vgenres && message.fav_vgenres.length) {
            object.fav_vgenres = [];
            for (let j = 0; j < message.fav_vgenres.length; ++j)
                object.fav_vgenres[j] = message.fav_vgenres[j];
        }
        if (message.fav_vplatforms && message.fav_vplatforms.length) {
            object.fav_vplatforms = [];
            for (let j = 0; j < message.fav_vplatforms.length; ++j)
        ...
        if (message.fav_bgames && message.fav_bgames.length) {
            object.fav_bgames = [];
            for (let j = 0; j < message.fav_bgames.length; ++j)
        ...
        if (message.known_langs && message.known_langs.length) {
            object.known_langs = [];
            for (let j = 0; j < message.known_langs.length; ++j)
        ...
        if (message.wanting && message.wanting.length) {
            object.wanting = [];
            for (let j = 0; j < message.wanting.length; ++j)
        ...
        if (message.interests && message.interests.length) {
            object.interests = [];
            for (let j = 0; j < message.interests.length; ++j)
...
export const EmitStatus = $root.EmitStatus = (() => {
    ...
    EmitStatus.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.EmitStatus();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    EmitStatus.fromObject = function fromObject(object) {
        if (object instanceof $root.EmitStatus)
            return object;
        let message = new $root.EmitStatus();
        if (object.time_active != null)
            message.time_active = object.time_active | 0;
        return message;
    };
...
export const Limits = $root.Limits = (() => {
    ...
    Limits.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Limits();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    Limits.verify = function verify(message) {
        ...
        if (message.permanent != null && message.hasOwnProperty("permanent")) {
            let error = $root.PermanentLimits.verify(message.permanent);
            if (error)
                return "permanent." + error;
        }
        if (message.daily != null && message.hasOwnProperty("daily")) {
            let error = $root.DailyLimits.verify(message.daily);
            if (error)
                return "daily." + error;
        }
        if (message.monthly != null && message.hasOwnProperty("monthly")) {
            let error = $root.MonthlyLimits.verify(message.monthly);
            if (error)
...
export const PermanentLimits = $root.PermanentLimits = (() => {
    ...
    PermanentLimits.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PermanentLimits();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    PermanentLimits.fromObject = function fromObject(object) {
        if (object instanceof $root.PermanentLimits)
            return object;
        let message = new $root.PermanentLimits();
        if (object.id != null)
            message.id = String(object.id);
        if (object.owner_id != null)
            message.owner_id = String(object.owner_id);
...
export const DailyLimits = $root.DailyLimits = (() => {
    ...
    DailyLimits.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DailyLimits();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    DailyLimits.fromObject = function fromObject(object) {
        if (object instanceof $root.DailyLimits)
            return object;
        let message = new $root.DailyLimits();
        if (object.id != null)
            message.id = String(object.id);
        if (object.owner_id != null)
            message.owner_id = String(object.owner_id);
...
export const MonthlyLimits = $root.MonthlyLimits = (() => {
    ...
    MonthlyLimits.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MonthlyLimits();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    MonthlyLimits.fromObject = function fromObject(object) {
        if (object instanceof $root.MonthlyLimits)
            return object;
        let message = new $root.MonthlyLimits();
        if (object.id != null)
            message.id = String(object.id);
        if (object.owner_id != null)
            message.owner_id = String(object.owner_id);
...
export const Media = $root.Media = (() => {
    ...
    Media.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Media();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const Likes = $root.Likes = (() => {
    ...
    Likes.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Likes();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const Dislikes = $root.Dislikes = (() => {
    ...
    Dislikes.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Dislikes();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const Conversations = $root.Conversations = (() => {
    ...
    Conversations.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Conversations();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    Conversations.fromObject = function fromObject(object) {
        if (object instanceof $root.Conversations)
            return object;
        let message = new $root.Conversations();
        if (object.id != null)
            message.id = String(object.id);
...
export const ConversationList = $root.ConversationList = (() => {
    ...
    ConversationList.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ConversationList();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    ConversationList.verify = function verify(message) {
        ...
        if (message.conversations != null && message.hasOwnProperty("conversations")) {
            ...
            for (let i = 0; i < message.conversations.length; ++i) {
                let error = $root.Conversations.verify(message.conversations[i]);
                if (error)
    ...
    ConversationList.fromObject = function fromObject(object) {
        if (object instanceof $root.ConversationList)
            return object;
        let message = new $root.ConversationList();
        if (object.take != null)
...
export const Messages = $root.Messages = (() => {
    ...
    Messages.encode = function encode(message, writer) {
        ...
        if (message.edit_history != null && message.edit_history.length)
            for (let i = 0; i < message.edit_history.length; ++i)
    ...
    Messages.verify = function verify(message) {
        ...
        if (message.edit_history != null && message.hasOwnProperty("edit_history")) {
            ...
            for (let i = 0; i < message.edit_history.length; ++i) {
                let error = $root.EditHistory.verify(message.edit_history[i]);
                if (error)
    ...
    Messages.fromObject = function fromObject(object) {
        ...
        if (object.edit_history) {
            ...
            message.edit_history = [];
            for (let i = 0; i < object.edit_history.length; ++i) {
    ...
    Messages.toObject = function toObject(message, options) {
        ...
        if (message.edit_history && message.edit_history.length) {
            object.edit_history = [];
            for (let j = 0; j < message.edit_history.length; ++j)
...
export const EditMessage = $root.EditMessage = (() => {
    ...
    EditMessage.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.EditMessage();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    EditMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.EditMessage)
            return object;
        let message = new $root.EditMessage();
        if (object.id != null)
            message.id = String(object.id);
        if (object.content != null)
            message.content = String(object.content);
...
export const EditHistory = $root.EditHistory = (() => {
    ...
    EditHistory.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.EditHistory();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    EditHistory.fromObject = function fromObject(object) {
        if (object instanceof $root.EditHistory)
            return object;
        let message = new $root.EditHistory();
        if (object.message != null)
            message.message = String(object.message);
        if (object.time_edited != null)
            message.time_edited = String(object.time_edited);
...
export const Messagelist = $root.Messagelist = (() => {
    ...
    Messagelist.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Messagelist();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    Messagelist.verify = function verify(message) {
        ...
        if (message.messages != null && message.hasOwnProperty("messages")) {
            ...
            for (let i = 0; i < message.messages.length; ++i) {
                let error = $root.Messages.verify(message.messages[i]);
                if (error)
    ...
    Messagelist.fromObject = function fromObject(object) {
        if (object instanceof $root.Messagelist)
            return object;
        let message = new $root.Messagelist();
        if (object.take != null)
            message.take = object.take | 0;
        if (object.skip != null)
            message.skip = object.skip | 0;
...
export const VideoGames = $root.VideoGames = (() => {
    ...
    VideoGames.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VideoGames();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    VideoGames.fromObject = function fromObject(object) {
        if (object instanceof $root.VideoGames)
            return object;
        let message = new $root.VideoGames();
        if (object.id != null)
            message.id = String(object.id);
        if (object.name != null)
...
export const AuthorizeByPhoneRequest = $root.AuthorizeByPhoneRequest = (() => {
    ...
    AuthorizeByPhoneRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.AuthorizeByPhoneRequest();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    AuthorizeByPhoneRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.AuthorizeByPhoneRequest)
            return object;
        let message = new $root.AuthorizeByPhoneRequest();
        if (object.phone != null)
            message.phone = String(object.phone);
        if (object.OTP != null)
...
export const SyncResponse = $root.SyncResponse = (() => {
    ...
    SyncResponse.verify = function verify(message) {
        ...
        if (message.datingProfile != null && message.hasOwnProperty("datingProfile")) {
            let error = $root.DatingProfile.verify(message.datingProfile);
            if (error)
...
export const ServerError = $root.ServerError = (() => {
    ...
    ServerError.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerError();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    ServerError.fromObject = function fromObject(object) {
        if (object instanceof $root.ServerError)
            return object;
        let message = new $root.ServerError();
        if (object.message != null)
            message.message = String(object.message);
        return message;
    };
...
export const ClientError = $root.ClientError = (() => {
    ...
    ClientError.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientError();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    ClientError.fromObject = function fromObject(object) {
        if (object instanceof $root.ClientError)
            return object;
        let message = new $root.ClientError();
        if (object.message != null)
            message.message = String(object.message);
...
export const SpecifyRequest = $root.SpecifyRequest = (() => {
    ...
    SpecifyRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.SpecifyRequest();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    SpecifyRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.SpecifyRequest)
            return object;
        let message = new $root.SpecifyRequest();
        if (object.id != null)
            message.id = String(object.id);
        return message;
    };
...
export const Blank = $root.Blank = (() => {
    ...
    Blank.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Blank();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
...
export const ChangeEvent = $root.ChangeEvent = (() => {
    ...
    ChangeEvent.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChangeEvent();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    ChangeEvent.verify = function verify(message) {
        ...
        if (message.media != null && message.hasOwnProperty("media")) {
            properties._media = 1;
            {
                let error = $root.Media.verify(message.media);
                if (error)
                    return "media." + error;
            }
        }
        if (message.likes != null && message.hasOwnProperty("likes")) {
            properties._likes = 1;
            {
                let error = $root.Likes.verify(message.likes);
                if (error)
                    return "likes." + error;
            }
        }
        if (message.dislikes != null && message.hasOwnProperty("dislikes")) {
            ...
            {
                let error = $root.Dislikes.verify(message.dislikes);
                if (error)
                    return "dislikes." + error;
            }
        }
        ...
        if (message.conversations != null && message.hasOwnProperty("conversations")) {
            ...
            {
                let error = $root.Conversations.verify(message.conversations);
                if (error)
                    return "conversations." + error;
            }
        }
        if (message.messages != null && message.hasOwnProperty("messages")) {
            ...
            {
                let error = $root.Messages.verify(message.messages);
                if (error)
                    return "messages." + error;
            }
        }
    ...
    ChangeEvent.fromObject = function fromObject(object) {
        if (object instanceof $root.ChangeEvent)
            return object;
        let message = new $root.ChangeEvent();
        if (object.type != null)
